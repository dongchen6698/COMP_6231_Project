...
/**
* ClinicServer/ClinicServerIntPOA.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from ClinicServer.idl
* Sunday, July 31, 2016 1:56:33 PM EDT
*/

public abstract class ClinicServerIntPOA extends org.omg.PortableServer.Servant
 implements Server_Group.Replica_2.ClinicServer.ClinicServerIntOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // ClinicServer/ClinicServerInt/createDRecord
       {
       ...
       case 1:  // ClinicServer/ClinicServerInt/createNRecord
       {
         String mangerId = in.read_string ();
         String firstName = in.read_string ();
         String lastName = in.read_string ();
         ...
         String $result = null;
         $result = this.createNRecord (mangerId, firstName, lastName, designation, status, statusDate);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }

       case 2:  // ClinicServer/ClinicServerInt/getRecordCounts
       {
         String managerId = in.read_string ();
       ...
       case 3:  // ClinicServer/ClinicServerInt/editRecord
       {
         String managerId = in.read_string ();
       ...
       case 4:  // ClinicServer/ClinicServerInt/transferRecord
       {
         String managerID = in.read_string ();
         String recordID = in.read_string ();
  ...
  private static String[] __ids = {
    "IDL:ClinicServer/ClinicServerInt:1.0"};
  ...
  public ClinicServerInt _this() 
  {
    return ClinicServerIntHelper.narrow(
    super._this_object());
  }

  public ClinicServerInt _this(org.omg.CORBA.ORB orb) 
  {
    return ClinicServerIntHelper.narrow(
