...
/**
* ClinicServer/_ClinicServerIntStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from ClinicServer.idl
* Sunday, July 31, 2016 1:56:33 PM EDT
*/

public class _ClinicServerIntStub extends org.omg.CORBA.portable.ObjectImpl implements Server_Group.Replica_2.ClinicServer.ClinicServerInt
{
  ...
  public String createNRecord (String mangerId, String firstName, String lastName, String designation, String status, String statusDate)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("createNRecord", true);
                $out.write_string (mangerId);
                $out.write_string (firstName);
                $out.write_string (lastName);
                ...
                return createNRecord (mangerId, firstName, lastName, designation, status, statusDate        );
            } finally {
                _releaseReply ($in);
            }
  } // createNRecord
