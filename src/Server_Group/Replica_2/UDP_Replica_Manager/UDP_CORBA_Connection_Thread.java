    ...
    public UDP_CORBA_Connection_Thread(DatagramSocket n_socket, DatagramPacket n_request) {
        ...
        switch (function_ID) {
            ...
            case "005":
                ...
                break;
            case "006":
                Server_Group.Replica_2.UDP_Replica_Manager.FailureDetection failureDetector = new Server_Group.Replica_2.UDP_Replica_Manager.FailureDetection();
                failureDetector.replyToPing(Server_Group.Replica_2.UDP_Replica_Manager.Replica_Manager_Config.LOCAL_FRONT_END_LISTENING_PORT, socket);
                break;
        }
        this.start();
    }
